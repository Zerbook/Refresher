package ru.igsanov.refresher.dialog;
...
public class AddingTaskDilogFragment extends DialogFragment {
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            throw  new ClassCastException(activity.toString() + " must implment AddingTaskListener");
        }
    }
